...
import { InCircle, PointSound, VideoPanel } from '@hiber3d/hdk-react-components';
...
const Sofa: HDKComponent = props => (
  <HNode {...props}>
    <InCircle
      ...
      renderItem={
        <>
          <Prefab id="rounded_cube_01" scaleX={0.8} scaleZ={0.3} scaleY={0.3} material="t_white_paint_01" />
          <Prefab id="rounded_cube_01" scaleX={0.2} scaleZ={0.4} scaleY={0.5} x={0.61} material="t_white_paint_01" />
        </>
      }
    />
    <Prefab id="rounded_cube_01" scaleX={0.8} scaleZ={0.8} scaleY={0.3} z={1} x={1.1} material="t_white_paint_01" />
    <InCircle
      x={2.2}
      z={2}
      rotY={180}
    ...
    <GLB src="https://cdn.hibervr.com/dia/Funky-Migelo-Luulia.glb" y={2} x={5} />
  </HNode>
);
  ...
  return (
    <HNode {...props}>
      ...
      <VideoPanel
        ...
        rotY={-250}
      />
      <PointSound y={1.5} x={8} z={2} src={{ url: `${CDN}/audio/resume_video_sound.mp3` }} radius={23} />
      <VideoPanel
