...
import { Avatar, DualDisplay, Hovering, Invisible, Spinning } from '@hiber3d/hdk-react-components';
import { CDN } from '../../config';
import { InfluencerWithInfoPanel } from './InfluencerWithInfoPanel';

const HoveringParticles: HDKComponent<{ prefab: PrefabId; material?: MaterialId }> = ({
  prefab,
  material,
  ...props
}) => (
  ...
  return (
    <HNode {...props}>
      ...
      <HNode x={-20} z={10} rotY={120}>
        ...
        <Avatar
          src={{ url: 'https://models.readyplayer.me/64883864d289fe75f63fa83b.glb' }}
        ...
        <Prefab id="lounge_sofa_01" scale={1.5} y={-0.1} z={-0.2} material="palette_01_white" />
        <HNode
          x={4.5}
          z={-0.3}
          scale={8}
          rotY={120}
          engineProps={{ rendering: { meshID: 'en_p_flower_03', materialID: 'en_p_flower_01' } }}
        />
      </HNode>

      {/* Tadeleyee */}
      <HNode x={19.8} z={-9.9} rotY={-55}>
        <InfoPanel header="Tadeleyee" preBody="Designer, model and influencer from East London" maxShowDistance={5}>
          <Invisible>
            <Apply props={{ engineProps: { collider: { collisionMask: 0 } } }}>
              <Prefab id="cube_01" />
            </Apply>
        ...
        <Avatar
          src={{ url: 'https://models.readyplayer.me/648835524e7fe89b29a59f3f.glb' }}
          animation="an_default_emote_sitting_idle_02"
          scale={2}
        />
        <DualDisplay
        ...
        <Prefab id="display_shelf_04" y={0} x={4} z={2} rotY={20}>
          <Prefab id={'storeprop_purse_03' as PrefabId} y={1.2} x={-0.2} z={0.05} />
      ...
      <HNode x={-11.2} z={-21.2} rotY={29}>
        <InfoPanel header="Caroline Ebo" preBody="London based Norwegian influencer" body="" maxShowDistance={5}>
          <Invisible>
            <Apply props={{ engineProps: { collider: { collisionMask: 0 } } }}>
              <Prefab id="cube_01" />
            </Apply>
        ...
        <Avatar
          src={{ url: 'https://models.readyplayer.me/648836bd3133f8119d3ef414.glb' }}
        ...
        <HoveringParticles prefab="sphere_01" material="t_metal_03" x={-4} z={1} scale={1.5} />
      </HNode>
      ...
      <InfluencerWithInfoPanel
        ...
        src={{ url: 'https://models.readyplayer.me/6491b7d7cbaee4f11cfb0480.glb' }}
      />
      <InfluencerWithInfoPanel
        x={23.3}
        y={0.5}
        ...
        src={{ url: 'https://models.readyplayer.me/6491bb90b640f0815e63cd3d.glb' }}
      />
      {/* Chilling in lounge */}
      <InfluencerWithInfoPanel
        x={-5.8}
        ...
        src={{ url: 'https://models.readyplayer.me/6492b3c33cb297021823e391.glb' }}
      />
      <InfluencerWithInfoPanel
        x={-8.7}
        y={0.0}
        ...
        src={{ url: 'https://models.readyplayer.me/6492b5707c8b09c4f6cd7470.glb' }}
      />
      <InfluencerWithInfoPanel
        x={-5.3}
        y={0.0}
        ...
        src={{ url: 'https://models.readyplayer.me/6492c15caa4d19417a03586b.glb' }}
      />
      <InfluencerWithInfoPanel
        x={-8.1}
        y={0.0}
        ...
        src={{ url: 'https://models.readyplayer.me/6492c290683398e4159995bf.glb' }}
      />
    </HNode>
  );
};
