...
const DJBooth: HDKComponent = ({ ...props }) => (
  ...
  >
    ...
    <Avatar
      src={{
        url: "https://models.readyplayer.me/64883b203133f8119d3efa50.glb",
      }}
    ...
    />
    <ImagePanel
      src="https://cdn.hibervr.com/dia/diapanel.png"
      ratio={1000 / 621}
      z={-0.5}
      y={0}
      scale={0.62}
  ...
  return (
    <HNode {...props}>
      ...
      <InCircle
        ...
        faceCenter
        renderItem={
          <Prefab id="en_p_speaker_02" rotY={-90} rotX={20} scale={1.5} />
        }
      />
      <Particles />
      <ImageTexture src="https://cdn.hibervr.com/dia/blue.png">
      ...
      <Audio
        ...
        y={5}
        src={{ url: `${CDN}/audio/dj_metaverse_mix.mp3` }}
      ></Audio>
      ...
      <InfluencerWithInfoPanel
        ...
        src={{
          url: "https://models.readyplayer.me/64930f5c7e9186ff7e3e6d43.glb",
        }}
        animation="an_default_emote_listening_to_music_01"
      />
      <InfluencerWithInfoPanel
        ...
        src={{
          url: "https://models.readyplayer.me/649316fb7e9186ff7e3ea045.glb",
        }}
      ...
      <InfluencerWithInfoPanel
        ...
        src={{
          url: "https://models.readyplayer.me/64931801683398e4159b27b9.glb",
        }}
      ...
      <InfluencerWithInfoPanel
        ...
        src={{
          url: "https://models.readyplayer.me/64931a13683398e4159b3281.glb",
        }}
      ...
      >
        ...
        <ImagePanel
          ...
          z={-1}
          scale={1.5}
          src={`${CDN}/images/dia_sound_tshirt.jpg`}
        />
      </InfoPanel>
      {props.children}
    </HNode>
